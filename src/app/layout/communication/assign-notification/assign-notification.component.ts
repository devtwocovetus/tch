...
@Component({
	selector: 'app-assign-notification',
	templateUrl: './assign-notification.component.html',
	styleUrls: ['./assign-notification.component.css']
})
export class AssignNotificationComponent implements OnInit {
	getbookingID
	dataListArray
	showLoader
	admin
