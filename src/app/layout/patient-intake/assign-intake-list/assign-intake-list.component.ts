...
@Component({
  selector: 'app-assign-intake-list',
  templateUrl: './assign-intake-list.component.html',
  styleUrls: ['./assign-intake-list.component.css']
})
export class AssignIntakeListComponent implements OnInit {
	showLoader
	admin
	setAccToSurgery
	dataListArray
