  	...
  	$("#sh-form-bulder").each(function(){
  		...
  		$("#"+id+" .sh-element, #"+id+".sh-element").sortable({
  			...
  			stop: function(event, ui) {			
  				...
  				if(localStorage.getItem('setFormBuilder')){
  					MetaElement = JSON.parse(localStorage.getItem('setFormBuilder'))
  				}
  			}
  		});
  	});
...
switch(elename) {
	...
	$("#sh-form-bulder").append("<div class='form-group  block-element bl-ele' id=sh-element"+VEId+">"+
		"<h3 id='HD"+VEId+"' class='title_text'>Title</h3>"+
		"<span class='help-block'>Type Description</span>"+
		"</div>");

	MetaElementStore('sh-element'+VEId,TITLEElEMENT,'0','Title','','Type Description','',VEId,1,0,'title',0);
	break;

	case TEXTEDITOR:
	$("#sh-form-bulder").append("<div class='form-group  block-element bl-ele' id=sh-element"+VEId+">"+
		"<label class='col-md-12 text-left text-dark text-strong blocklabel' for='textinput'>Text Editor</label>"+
		"<div class='col-md-12'>"+
		...
		"</div>"+
		"</div>");
	MetaElementStore('sh-element'+VEId,TEXTEDITOR,'0','Text Editor','','Type Description','',VEId,1,0,'texteditor',0,'Type Description');
	break;
	case TEXTElEMENT:
	$("#sh-form-bulder").append("<div class='form-group  block-element bl-ele' id=sh-element"+VEId+">"+
		"<label class='col-md-12 text-left text-dark text-strong blocklabel' for='textinput'>Text Input</label>"+
		"<div class='col-md-12'>"+
		...
		"</div>"+
		"</div>");
	MetaElementStore('sh-element'+VEId,TEXTElEMENT,'0','Text Input','placeholder','Type something.','',VEId,1,0,'textbox',0,'Type something');
	break;
	case EMAILElEMENT:
	$("#sh-form-bulder").append("<div class='form-group  block-element bl-ele' id=sh-element"+VEId+">"+
		"<label class='col-md-12 text-left text-dark text-strong blocklabel' for='textinput'>Text Input Email</label>"+
		"<div class='col-md-12'>"+
	...
	case FILEElEMENT:
	$("#sh-form-bulder").append("<div class='form-group  block-element bl-ele' id=sh-element"+VEId+">"+
		"<label class='col-md-12 text-left text-dark text-strong blocklabel' for='filebutton'>File Button</label>"+
		"<div class='col-md-12'>"+
		"<input id='textinput"+VEId+"' name='textinput"+VEId+"' type='file' placeholder='placeholder' class='input-file'>"+	
		"<span class='help-block'>Upload something</span>"+
		"</div>"+
		"</div>");
	MetaElementStore('sh-element'+VEId,FILEElEMENT,'0','File','Placeholder','Upload Something','',VEId,1,0,'file',0,'Upload Something');
	break;	
	...
	$("#sh-form-bulder").append("<div class='form-group block-element bl-ele' style='height:180px;' id=sh-element"+VEId+">"+
		...
		"<div class='col-md-8'>"+
		"<canvas id=myCanvas"+VEId+"  style='border:1px solid black; width:150px; height:75px;'></canvas>"+
		"<br /><br />"+
		"<button onclick='javascript:clearArea(myCanvas"+VEId+");return false;'>Clear Area</button>&nbsp; &nbsp; "+
...
function LayoutF()
{
	...
	function FElementTitle(m)
	{
		...
		"<h3 id='HD"+VEId+"' class='title_text'>"+MetaElement[m].Label+"</h3>"+
...
{debugger;
	...
	if(MetaElement[m].IsRequired == 0)
		...
		ReqObj = "required";
	StrObj =  "<div class=form-group block-element bl-ele' style='height:220px;' id=sh-element"+VEId+">"+
	"<label class='col-md-12 text-left text-dark text-strong blocklabel' for='filebutton'>Signature</label>"+											
	"<div class='col-md-8'>"+
	"<canvas id=myCanvasp"+VEId+"  style='border:1px solid black; width:300px; height:150px;'></canvas>"+
	"<br /><br />"+
	"<button onclick='javascript:clearArea(myCanvasp"+VEId+");return false;'>Clear Area</button>"+
	"<button onclick='javascript:convertCanvasToImage(myCanvasp"+VEId+");return false;'>Save</button>"+
	"</div>"+
	"</div>";
...
function FElementFile(m)
{
	...
	"<label class='col-md-12 text-left text-dark text-strong blocklabel' for='textinput'>"+MetaElement[m].Label+"</label>"+
	"<div class='col-md-12'>"+
	"<input id='textinput"+VEId+"' "+ReqObj+" name='textinput"+VEId+"' type='file'  class='form-control input-md'>"+	
	"<span class='help-block'>"+MetaElement[m].Description+"</span>"+
	"</div>"+
	"</div>";
